...
def start(X_image,y_label):
    ...
    print('\nMLP with 786 input nodes and 10 output nodes')
...
def print_metrics():
    print('\nAverage Accuracy of Multi-layer-Perceptron model   :', round(np.average(Accuracy),4))
    print('\nAverage Precision of Multi-layer-Perceptron model  :', round(np.average(Precision),4))
    print('\nAverage Recall of Multi-layer-Perceptron model     :', round(np.average(Recall),4))
    print('\nAverage Specificity of Multi-layer-Perceptron model:', round(np.average(Specificity), 4))
def getAccuracy():
