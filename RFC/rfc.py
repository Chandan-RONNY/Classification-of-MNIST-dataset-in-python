...
def start(X_image,y_label):
    ...
    print('\nRFC with 100 estimators and 10 jobs')
...
def print_metrics():
    print('\nAverage Accuracy of Random forest classification model     :', round(np.average(Accuracy),4))
    print('\nAverage Precision of Random forest  classification model   :', round(np.average(Precision),4))
    print('\nAverage Recall of Random forest classification model       :', round(np.average(Recall),4))
    print('\nAverage Specificity of Random forest classification        :', round(np.average(Specificity), 4))
